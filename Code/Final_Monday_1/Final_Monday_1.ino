// updated changes in turns, r wheel speed
...
#define R_WHEEL_MIN  220  // 238 (-100 mapped) full REVERSE; 360 is STOPPED (0 mapped)  230
#define R_WHEEL_MAX  500  // 482 (100 mapped) full FORWARD,                             490
...
float trackKp = 0.08,   // 0.08 works well
      trackKd = 0.08,   // 0.08 works well
      followKp = 0.7,   // 0.7 works well
      followKd = 0.08;  // 0.08
