...
#define R_WHEEL_MIN  220 // 238 (-100 mapped) full REVERSE; 360 is STOPPED (0 mapped)  220
#define R_WHEEL_MAX  500 // 482 (100 mapped) full FORWARD,                             500
...
float trackKp = 0.16, // 0.08 works well
      trackKd = 0.15,  // 0.1 works well
      followKp = 0.6, // 0.8 works well  1.6
      followKd = 0.00; // 0.2 works well 0.8
