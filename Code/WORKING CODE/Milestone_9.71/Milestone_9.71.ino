...
#define R_WHEEL_MIN  230 // 238 (-100 mapped) full REVERSE; 360 is STOPPED (0 mapped)  220
#define R_WHEEL_MAX  490 // 482 (100 mapped) full FORWARD,                             500
...
float trackKp = 0.08, // 0.08 works well
      trackKd = 0.08,  // 0.1 works well
      followKp = 0.8, // 0.8 works well  1.6
      followKd = 0.08, // 0.2 works well 0.8
      headingKp = 0.7,
      headingKd = 0.0,
      heading = 400,
      course = 360,
